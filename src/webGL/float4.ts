...
export class Float4 {
	...
	get elements(): [number, number, number, number] { return [this._x, this._y, this._z, this._w]; }
	set elements(value: [number, number, number, number]) { this._x = value[0]; this._y = value[1]; this._z = value[2]; this._w = value[3]; }
